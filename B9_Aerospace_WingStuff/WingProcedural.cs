...
namespace WingProcedural
{
    public class WingProcedural : PartModule
    {
        ...
        [KSPField (isPersistant = true, guiActive = false, guiActiveEditor = true, guiName = "Edge scale (trailing)"),
        ...
        [KSPField (isPersistant = true, guiActive = false, guiActiveEditor = true, guiName = "Edge scale (leading)"),
        UI_FloatRange (minValue = 0f, maxValue = 1f, scene = UI_Scene.Editor, stepIncrement = 0.25f)]
        ...
        [KSPEvent (guiActiveEditor = true, guiName = "Side A: Medium | Next")]
        public void SelectNextSurfaceTop ()
        {
            ...
            SelectNextSurfaceGeneric (wingSurfaceTextureTop, "Top", "A", true);
        }
        ...
        public void Update ()
        {
            if (HighLogic.LoadedSceneIsEditor)
            {
                ...
                //else if (isAttached)
                //{
                //    Debug.Log ("WP | Update | Setup started");
                //    Setup ();
                //    isStarted = true;
                //}
            }
